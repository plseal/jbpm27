...
<div class="container">
	...
	<div class="row">
		<br/><br/><br/>
		<a href="javascript:news_complete();"  class="button button-block button-rounded button-primary button-large">完成</a>
	</div>
	...
	<script>
		...
		function news_complete(){
			
		
			document.all.myform.action="${pageContext.request.contextPath}/news/index.jsp";
