...
<div class="container">
	...
	<div class="row">
		第二步：<%=request.getParameter("news_div").toString() %>(上传PDF文件)
		<div class="progress">
	...
	<input type = "hidden" id = "news_beSelected_div" value = '<%=request.getParameter("news_div").toString() %>'>
	</div>
	<div class="row">
		<br/>
    	<br/>
...
function uploadFile(){
	...
	if (file_name == ""){
		...
		document.all.myform.action="${pageContext.request.contextPath}/uploadFile/uploadNews.do?news_beSelected_div="+document.all.news_beSelected_div.value;
